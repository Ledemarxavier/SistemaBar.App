...
public class TelaConta : ITela
{
    ...
    public void CadastrarRegistro()
    {
        ...
        bool mesaOcupada = repositorioConta.SelecionarContasEmAberto().Any(c => c.Mesa.Id == novaConta.Mesa.Id);
        if (mesaOcupada)
        {
            ApresentarMensagem("Essa mesa já possui uma conta em aberto!", ConsoleColor.Red);
            return;
        }
